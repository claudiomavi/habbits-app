...
export function CreateProfile() {
	...
	return (
		...
		>
			...
			>
				{/* Tarjeta principal */}
				<View className="bg-white rounded-3xl p-8 elevation-lg overflow-hidden">
							...
							<View className="flex-row justify-center gap-5">
								{avatars.map((avatar) => (
									<TouchableOpacity
										...
										className={`items-center p-3 rounded-3xl border-2 bg-gray-100 border-transparent ${selectedAvatar === avatar.uri && 'border-blue-400 bg-blue-100'}`}
										activeOpacity={0.7}
									>
										<Image
										...
										/>
										<Text
											className={`font-semibold text-gray-500 ${selectedAvatar === avatar.uri && 'text-blue-500'}`}
										>
											{avatar.label}
										</Text>
									</TouchableOpacity>
